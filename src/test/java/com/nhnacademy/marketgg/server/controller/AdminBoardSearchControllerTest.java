...
@WebMvcTest(AdminBoardSearchController.class)
class AdminBoardSearchControllerTest {
    ...
    private static final String DEFAULT_ADMIN_SEARCH = "/shop/v1/admin/search/boards";
    ...
    void searchForCategoryForNotice(String categoryCode, String type) throws Exception {
        ...
        MvcResult mvcResult =
                mockMvc.perform(post(DEFAULT_ADMIN_SEARCH + "/categories/{categoryCode}", categoryCode)
                                        .param("keyword", "안녕")
                                        .param("page", "0")
                                        .param("size", "1"))
    ...
    void searchForCategoryForNotFoundException() throws Exception {
        ...
        MvcResult mvcResult = this.mockMvc.perform(
                                          post(DEFAULT_ADMIN_SEARCH + "/categories/{categoryCode}", "705")
                                                  .param("keyword", "안녕")
                                                  .param("page", "0")
                                                  .param("size", "1"))
                                          .andExpect(status().isOk())
    ...
    void searchForReason() throws Exception {
        ...
        MvcResult mvcResult =
                mockMvc.perform(post(DEFAULT_ADMIN_SEARCH + "/categories/{categoryCode}/reason", "11")
                                        .param("reason", "환불")
                                        .param("keyword", "안녕")
                                        .param("page", "0")
                                        .param("size", "1"))
    ...
    void searchForStatus() throws Exception {
        ...
        MvcResult mvcResult =
                mockMvc.perform(post(DEFAULT_ADMIN_SEARCH + "/categories/{categoryCode}/status", "11")
                                        .param("status", "종료")
                                        .param("keyword", "안녕")
                                        .param("page", "0")
                                        .param("size", "1"))
